 ...
 * @author MELON
 */
public class EditAkunBisnis extends javax.swing.JFrame {
    private UserController usercontroller;
private UserModel usermodel;

    /**
     * Creates new form EditAkunBisnis
     */
    public EditAkunBisnis() {
        initComponents();
...
if (ja == 1){
    ...
    private void SimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SimpanActionPerformed
        ...
        if (level == 0){
            ...
            if (hasil){
                ...
                EditAkunBisnis home = new EditAkunBisnis();
                home.setVisible(true);
                this.dispose();
            }
        }    // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditAkunBisnis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditAkunBisnis().setVisible(true);
            }
        });
    }
